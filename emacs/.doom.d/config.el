...
;;   (define-key evil-motion-state-map (kbd ";") 'latex-add-newline))


;; (map! :leader
;;       :desc "LaTeX Add Newline"
;;       'l' #'latex-add-newline)
(map! :leader
      (:prefix-map ("l" . "LaTeX Commands")
      :desc "LaTeX Add Newline" "n" 'latex-add-newline))
...
;; TSC Functions
;;
;; Add LaTeX newline symbol to end of line x number of times
(defun latex-add-newline (num)
  (interactive "p")
  (evil-set-marker ?m)
  (evil-append-line 1)
  (dotimes (count num)
